...
import { Product, Category, Brand, User, StoreSettings, Review } from './types';

// Icons SVG được sử dụng trong ứng dụng
export const ICONS = {
...
export const INITIAL_USERS: User[] = [
    { id: 'admin-1', name: 'Admin', email: 'admin@example.com', phone: '0123456789', addresses: [], role: 'admin' },
    { id: 'user-1', name: 'Nhật Anh', email: 'user@example.com', phone: '0987654321', addresses: ['123 Đường ABC, Quận 1, TP.HCM'], role: 'customer' },
];
